		...
		try {	
			...
			/* Attention aux erreurs de logique */
				...
				/* Le contexte vérifie des données d’un formulaire via l'existence de $_POST[] */
					if (isset($_POST['name'],$_POST['surname'],$_POST['user'],$_POST['password'],$_POST['email'],$_POST['date']) && !empty($_POST['name']) && !empty($_POST['surname']) && !empty($_POST['user']) && !empty($_POST['password']) && !empty($_POST['email']) && !empty($_POST['date'])) {

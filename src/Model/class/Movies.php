        ...
        public function renderMovieCard(array $film): string {
            ...
            <div class='movie'>
                <a class='title' href='index.php?page=details&id={$film['id']}'>
                    <img src='{$film['pochette']}' alt='" . htmlspecialchars($film['titre']) . "' class='img'>
                </a>
                <h3 style='margin-top:2%;line-height: 1.5em;max-height: 3em;overflow: hidden;'>" . htmlspecialchars($film['titre']) . "</h3>
                <p style='margin-top:-3%;;line-height: 1.5em;max-height: 3em;overflow: hidden;'" . ($subtitle ? 'margin-bottom:-8px' : '') . "'>$subtitle</p>
            </div>";
        }

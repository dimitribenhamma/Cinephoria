...
<section>
	...
	<div class="center">	
		...
		<div><button class="button buttons-text" style="cursor: pointer;" onclick="window.location.href='index.php?page=<?= $confirm ; ?>'"><?= $text_button ; ?></button></div> <!-- Bouton de navigation -->
	</div>
</section>
